...
export function TopNav() {
  ...
  return <header className="fixed top-0 left-0 right-0 z-30 w-full flex items-center justify-between py-3 px-4 backdrop-blur-md border-b border-white/20 shadow-sm bg-[#3878eb]">
