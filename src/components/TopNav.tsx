...
export function TopNav() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-30 w-full flex items-center justify-between py-3 px-4 bg-white/80 backdrop-blur-md border-b border-gray-200 shadow-sm">
