...
export default function Index() {
  ...
  return <div className="min-h-screen w-full bg-gradient-to-b from-[#3b9fe6] to-[#2a8dd9] flex flex-col relative overflow-x-clip">
      ...
      <div className="flex flex-col items-center justify-center flex-grow pt-[64px] pb-[160px] px-4">
        {/* Brand Logo */}
        <img alt="theTradesmen.ai logo" src="/lovable-uploads/1469542c-df73-456d-a0b0-baa6fdac06ca.png" className="w-64 h-64 mx-auto mb-4 object-scale-down" />
        ...
        <div className="relative max-w-xl w-full mb-4">
          <input className="w-full px-6 py-3 rounded-full bg-white/10 backdrop-blur text-white placeholder-white/50 text-base border border-white/15 focus:outline-none focus:ring-2 focus:ring-white/30 transition-all" placeholder="Describe the job, follow-up or task…" value={input} onChange={e => setInput(e.target.value)} />
        </div>
      ...
      {/* Floating Mic Button */}
      <button className="fixed bottom-[66px] left-1/2 transform -translate-x-1/2 w-14 h-14 rounded-full border-4 border-white bg-[#ffc000] shadow-xl flex items-center justify-center z-40 hover:scale-105 transition-all duration-150 ease-in-out active:scale-95" style={{
